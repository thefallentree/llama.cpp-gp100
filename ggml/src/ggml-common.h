...
typedef struct {
    ...
    uint8_t qs[QK4_1_G64 / 2]; // two Q4_1-layout 16-byte halves
} block_q4_1_g64;
static_assert(sizeof(block_q4_1_g64) == 2*sizeof(ggml_half) + QK4_1_G64/2, "wrong q4_1_g64 block size/padding");
