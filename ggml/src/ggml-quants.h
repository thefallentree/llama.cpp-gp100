...
GGML_API void quantize_row_q4_1_g64_ref(const float * GGML_RESTRICT x, block_q4_1_g64 * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_q4_1_g64(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
...
GGML_API void dequantize_row_q4_1_g64(const block_q4_1_g64 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
