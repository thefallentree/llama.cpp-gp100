...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_1_G64] = {
        .type_name                = "q4_1_g64",
        .blck_size                = QK4_1_G64,
        .type_size                = sizeof(block_q4_1_g64),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_1_g64,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_1_g64_ref,
    },
    [4] = { // GGML_TYPE_Q4_2
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_Q4_1_G64:      wtype = GGML_TYPE_Q4_1_G64; break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q4_1_G64:
            result = quantize_q4_1_g64(
                    src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix);
            break;
